...
const Wishlist = () => {
  ...
  //   },
  //   {
  //     logo: "https://cdn0.iconfinder.com/data/icons/food-and-drinks-1-8/36/76-64.png",
  //     name: "tee",
  //   },
  //   {
  //     logo: "https://cdn4.iconfinder.com/data/icons/food-and-drinks-3-8/36/289-512.png",
  //     name: "tee",
  //   },
  //   {
  //     logo: "https://cdn1.iconfinder.com/data/icons/party-48/64/cupcake_bakery_muffin_food-64.png",
  //     name: "tee",
  //   },
  //   {
  //     logo: "https://cdn0.iconfinder.com/data/icons/bakery-and-dessert-color/64/Milk_bakery_food_icon_doodle-64.png",
  //     name: "tee",
  //   },
  //   {
  //     logo: "https://www.iconfinder.com/icons/4028144/bakery_dessert_food_pie_icon",
  //     name: "tee",
  //   },
  // ];
  return (
